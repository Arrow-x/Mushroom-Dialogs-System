...
func set_up(cmd: ChangeUICommand, u_r: EditorUndoRedoManager, cmd_c: Node) -> void:
...
func _on_is_default_check_button_toggled(toggled_on: bool) -> void:
	...
	undo_redo.add_do_method(
		commands_container, "command_undo_redo_caller", "toggle_ui", [toggled_on]
	)
...
func _on_ui_drag_target_label_value_dragged(value: PackedScene) -> void:
	...
	undo_redo.add_do_method(
		commands_container, "command_undo_redo_caller", "change_ui_scene", [value]
	)
	undo_redo.add_undo_method(
		commands_container,
		"command_undo_redo_caller",
		"change_ui_scene",
		[current_change_ui.next_UI]
	)
	undo_redo.commit_action()
...
func _on_clear_button_pressed() -> void:
	undo_redo.create_action("drag a new UI scene")
	undo_redo.add_do_method(commands_container, "command_undo_redo_caller", "change_ui_scene")
	undo_redo.add_undo_method(
		commands_container,
		"command_undo_redo_caller",
		"change_ui_scene",
